...
select dt.SK_DIM_TIEMPO,  dc.SK_DIM_CLIENTE, dp.SK_DIM_PRODUCTO, deserv.SK_DIM_EVALUACION_SERVICIO
from SEGURO_G27625529.RECOMIENDA rr, 
left JOIN SEGURO_DW_27985940.DIM_CLIENTE dc ON rr.COD_CLIENTE= rc.COD_CLIENTE
left join SEGURO_DW_27985940.DIM_TIEMPO dt ON dt.FECHA_COMPLETA=rr.RECOMIENDA_AMIGO
left join SEGURO_DW_27985940.DIM_PRODUCTO dp on rr.COD_PRODUCTO= rp.COD_PRODUCTO
